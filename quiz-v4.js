$(document).ready(function () {
    ...
    function updateScores() {
        ...
        if (highestValue < 100) {     // solo 
            ...
            switch (finalOutcome) {
                ...
                case 'scoreD':
                    var alternatives = [
                        { 
                            title: "Colonel Sanders and a chicken drumstick",
                            description: "To remind you to eat on the way home.",
                            imageURL: "img/outcome-penguins.png"
                        },
                        { 
                            title: "Beans and toast",
            ...
            switch (finalOutcome) {
                case 'scoreA':
                    var alternatives = [
                        ...
                        { 
                            title: "Bowling pins",
                            description: "You’ve got a ready-made excuse for if you fall over.",
        ...
        finalHTML += "<button id='retry-quiz' class='white'>Retry</button>";
        finalHTML += "</div>";

        finalHTML += "<div class='socials'>";
        finalHTML += "    <p>Share your selection</p>";
        finalHTML += "    <div>";
        finalHTML += "        <span id='social-whatsapp'></span>";
        finalHTML += "        <span id='social-facebook'></span>";
        finalHTML += "        <span id='social-twitter'></span>";
        finalHTML += "    </div>";
        finalHTML += "</div>";
